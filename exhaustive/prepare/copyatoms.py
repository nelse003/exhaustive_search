...
def copy_dimple_atoms(path, prefix, start_xtal_num, end_xtal_num,
...
copy_dimple_atoms(path="/dls/labxchem/data/2017/lb18145-49/processing/analysis/initial_model",
                  prefix='NUDT7A-x',
                  start_xtal_num=1906,
                  end_xtal_num=2005,
