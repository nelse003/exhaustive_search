...
if __name__ == "__main__":
    ...
    for xtal, compound in xtals_with_compound.items():
        ...
        if "DCP2B" in xtal:
            ...
            input_cif = "/dls/labxchem/data/2016/lb13385-64/processing/" \
            ...
            if compound == "FMOPL000622a_DSI_poised":
                ...
                input_cif = "/dls/labxchem/data/2018/lb18145-55/processing/" \
                ...
                folder_ext = compound
                input_cif = "/dls/labxchem/data/2018/lb18145-55/" \
            ...
            if compound == "OX210":
                ...
                input_cif = "/dls/labxchem/data/2017/lb18145-49/processing/analysis/initial_model" \
        ...
        refinement_script_dir = "/dls/science/groups/i04-1/elliot-dev/Work/" \
        ...
        if not os.path.exists(out_pdb) and not os.path.exists(out_mtz):
            ...
            os.system("source /dls/science/groups/i04-1/elliot-dev/ccp4/ccp4-7.0/bin/ccp4.setup-sh;" +
                      "cd {};".format(out_dir) +
                      "giant.make_restraints {}\n".format(os.path.join(out_dir,"input.pdb")))

            with open(os.path.join(out_dir, "multi-state-restraints.refmac.params"),"a+") as param_file:
            ...
            "{}_refmac_superposed.csh".format(xtal))
        ...
        if not os.path.exists(out_pdb) and not os.path.exists(out_mtz):
            ...
            with open(os.path.join(out_dir,"multi-state-restraints.phenix.params"),"a+") as param_file:
            ...
            # File location and name
            csh_file = os.path.join(refinement_script_dir,
            "{}_phenix_superposed.csh".format(xtal))
        ...
        if not os.path.exists(out_pdb) and not os.path.exists(out_mtz):
            ...
            # File location and name
            csh_file = os.path.join(refinement_script_dir,
                                    "{}_buster_superposed.csh".format(xtal))
