...
class TestSelectAtoms(unittest.TestCase):
    ...
    def test_get_bound_ground_states(self):
        ...
        ground_states, bound_states = get_bound_ground_states(
        ...
        self.assertIsInstance(ground_states[0][0], scitbx.array_family.flex.bool)
        ...
        self.assertIsInstance(bound_states[0][0], scitbx.array_family.flex.bool)
    ...
    def test_get_selection_altloc_resseq_chain(self):
        ...
        sel_alt = get_selection_altloc_resseq_chain(
            sel_cache=self.sel_cache, altlocs=["A", "B"], resseq=120, chain="S"
        )
